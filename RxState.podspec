#
#  Be sure to run `pod spec lint RxState.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Nazih Shoura" => "shoura.nazeeh@gmail.com" }
  # Or just: s.author    = "Nazih Shoura"
  # s.authors            = { "Nazih Shoura" => "shoura.nazeeh@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Nazih Shoura"
  ...
  s.source       = { :git => "https://github.com/RxSwiftCommunity/RxState.git", :tag => "#{s.version}" }
